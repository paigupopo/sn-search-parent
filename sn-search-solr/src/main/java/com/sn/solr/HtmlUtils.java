...
public class HtmlUtils {
    ...
    public static String Html2Text(String inputString) {
        ...
        try {
            ...
            String regEx_find = "<[\\s]*?find[^>]*?>[\\s\\S]*?<[\\s]*?\\/[\\s]*?find[\\s]*?>";
            ...
            p_find = Pattern.compile(regEx_find, Pattern.CASE_INSENSITIVE);
            m_find = p_find.matcher(htmlStr);
            htmlStr = m_find.replaceAll("");
