...
public class WzqMailbox implements Serializable {
    @Field
    private Long id;
    ...
    private Integer ffgroupid;

    private String ffgroupname;
    ...
    public String getReplycontent12() {
        return replycontent12;
    }

    public void setReplycontent12(String replycontent12) {
        this.replycontent12 = replycontent12 == null ? null : replycontent12.trim();
    }
    ...
    public Integer getFfgroupid() {
        return ffgroupid;
    }

    public void setFfgroupid(Integer ffgroupid) {
        this.ffgroupid = ffgroupid;
    }

    public String getFfgroupname() {
        return ffgroupname;
    }

    public void setFfgroupname(String ffgroupname) {
        this.ffgroupname = ffgroupname == null ? null : ffgroupname.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", replycontent12=").append(replycontent12);
        ...
        sb.append(", ffgroupid=").append(ffgroupid);
        sb.append(", ffgroupname=").append(ffgroupname);
        sb.append(", ffdate=").append(ffdate);
