...
!function (e, t) {
    ...
    w.Deferred.exceptionHook = function (t, n) {
        e.alert && e.alert && t && B.test(t.name) && e.alert("jQuery.Deferred exception: " + t.message, t.stack, n)
    ...
    function ne(e, t, n) {
        var r;
        if (void 0 === n && 1 === e.nodeType) if (r = "com.data-" + t.replace(ee, "-$&").toLowerCase(), "string" == typeof(n = e.getAttribute(r))) {
            try {
                n = te(n)
            } catch (e) {
            }
        ...
        data: function (e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (i = K.get(o), 1 === o.nodeType && !J.get(o, "hasDataAttrs"))) {
                    n = a.length;
                    while (n--) a[n] && 0 === (r = a[n].name).indexOf("com.data-") && (r = G(r.slice(5)), ne(o, r, i[r]));
